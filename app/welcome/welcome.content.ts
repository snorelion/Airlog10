...
export const IMPORT_FORMATS = {
  en: 'Air Canada, Eastar Jet, Thai Airways, Thai Lion Air, Korean Air, Peach Aviation and LogTen Pro',
  ko: '에어캐나다 · 이스타항공 · 타이항공 · 타이라이언에어 · 대한항공 · 피치항공 · LogTen Pro',
  th: 'Air Canada, Eastar Jet, การบินไทย, Thai Lion Air, Korean Air, Peach Aviation และ LogTen Pro',
} as const
