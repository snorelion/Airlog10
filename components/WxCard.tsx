  ...
  return (
    <div className="rounded-2xl border border-app-line bg-app-surface p-4">
      ...
      {!row ? (
        ...
        <>
          {row.metar && (
            <p className="mt-3 whitespace-pre-wrap break-all rounded-xl bg-app-bg p-3 font-mono text-[13px] leading-relaxed">
              {row.metar}
            </p>
          )}
          {row.taf && (
            <p className="mt-2 whitespace-pre-wrap break-all rounded-xl bg-app-bg p-3 font-mono text-[12px] leading-relaxed text-app-sub">
              {row.taf}
            </p>
          )}
          {age && (
